...
const mapper = ({ItemCode, PLUCode, Description, UnitPrice, Active, label10, label4, label5, isWeighed}) => ({id: PLUCode, ItemCode, Description, label4, label5, UnitPrice, label10, Active, isWeighed })

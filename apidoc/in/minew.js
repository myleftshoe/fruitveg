...
/**
 * @api {get} /V2/sence/using Usage Scenarios
 * @apiName Usage
 * @apiGroup Basic
 * @apiExample Headers
 *  {
...
/**
 * 
 * @api {post} /path Add Product
 * @apiName Add product information
 * @apiGroup Goods
 * @apiParam {String} storeUuid StoreId
 * @apiHeader {String} Authorization Bearer: Access Token [token] 
 * @apiBody {String} barcode Used as product id
 * @apiBody {String} qrcode Product QR Code
 * @apiExample {type} Request-Example:
 * {
 *     property : value
 * }
 * @apiExample {type} Success-Response:
 * {
 *     property : value
 * }
 * 
